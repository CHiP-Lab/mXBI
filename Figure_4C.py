...
def dataload_dpDF():
    dP_df = pd.read_csv('./data/Figure_4C_dPDF.csv', low_memory=False, decimal=',')
...
def dataload_HR():
    HR = pd.read_csv('./data/Figure_4C_HR.csv', low_memory=False, decimal=',')
...
def dataload_Responses():
    Responses = pd.read_csv('./data/Figure_4C_Responses.csv', low_memory=False, decimal=',')
