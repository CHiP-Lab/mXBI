...
def dataload():
    dP_df = pd.read_csv('./data/Figure_S1_dPDF.csv', low_memory=False, decimal=',')
    HR = pd.read_csv('./data/Figure_S1_HR.csv', low_memory=False, decimal=',')
    DATA_filtered = pd.read_csv('./data/Figure_S1_data.csv', low_memory=False, decimal=',')
    ABS = pd.read_csv('./data/Figure_S1_ABS.csv', low_memory=False, decimal=',')
    plot_df = pd.read_csv('./data/Figure_S1_plot.csv', low_memory=False, decimal=',')
